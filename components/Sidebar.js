...
export default function Sidebar(props) {
    const { isAuthenticated, nickname, setNickname, username, handleSetUsername } = useContext(PokemonContext);
    const styles = {
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.menu}>
                <Link href="/">
                    <div className={styles.menuItem}>
                        <Image alt="amazon" src={logo} width={30} height={30} className={styles.amazonLogo} />
                        My amazon <br /> board
                    </div>
                </Link>
                <div className={styles.menuItem}>
            ...
            <div className={styles.companyName}>
                <Image alt="amazon" src={logoFull} width={100} height={100} className={styles.amazonLogo} />
            </div>
        </div>
    );
}
